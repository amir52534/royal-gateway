...
:root{--bg:#0f0a04;--card:rgba(30,20,8,0.92);--accent:#F59E0B;--accent2:#FBBF24;--text:#FFF8ED;--dim:#8B7A5A;--mid:#C8B088;--border:rgba(245,158,11,0.2);--shadow-glow:rgba(245,158,11,0.15)}
...
.card{background:var(--card);border:1px solid var(--border);border-radius:24px;padding:40px 36px 36px;backdrop-filter:blur(24px);box-shadow:0 0 80px rgba(245,158,11,0.06),0 20px 60px rgba(0,0,0,.6);position:relative;overflow:hidden}
.card::before{content:'';position:absolute;top:-50%;left:-50%;width:200%;height:200%;background:radial-gradient(circle at 30% 20%,rgba(245,158,11,0.03),transparent 60%);pointer-events:none}
.brand{display:flex;align-items:center;gap:14px;margin-bottom:28px;position:relative;z-index:1}
...
.brand-name{font-size:18px;font-weight:800;color:var(--text);letter-spacing:-0.02em;background:linear-gradient(135deg,#FBBF24,#F59E0B);-webkit-background-clip:text;-webkit-text-fill-color:transparent}
.brand-sub{font-size:11px;color:var(--dim);margin-top:3px;letter-spacing:0.04em}
...
.hint{display:flex;align-items:center;gap:10px;background:rgba(245,158,11,0.06);border:1px solid rgba(245,158,11,0.12);border-radius:12px;padding:10px 14px;margin-bottom:20px;transition:0.3s;cursor:default}
.hint:hover{background:rgba(245,158,11,0.1);border-color:rgba(245,158,11,0.2)}
.hint-label{font-size:11px;color:var(--dim);flex:1}
.hint-val{font-family:ui-monospace,monospace;font-size:14px;font-weight:700;color:var(--accent);background:rgba(245,158,11,0.08);border:1px solid rgba(245,158,11,0.2);padding:3px 13px;border-radius:8px;cursor:pointer;transition:.2s;letter-spacing:.08em}
.hint-val:hover{background:rgba(245,158,11,0.18);transform:scale(1.02);box-shadow:0 0 20px rgba(245,158,11,0.1)}
...
input[type=password]:focus{border-color:rgba(245,158,11,.6);background:rgba(0,0,0,.45);box-shadow:0 0 0 4px rgba(245,158,11,.08),0 0 30px rgba(245,158,11,.03)}
...
.btn{width:100%;padding:14px;border-radius:13px;border:none;cursor:pointer;background:linear-gradient(135deg,#F59E0B,#D97706);color:#0f0a04;font-family:inherit;font-size:14px;font-weight:700;display:flex;align-items:center;justify-content:center;gap:8px;box-shadow:0 4px 25px rgba(245,158,11,.3);transition:.3s;position:relative;overflow:hidden}
.btn::before{content:'';position:absolute;inset:0;background:linear-gradient(135deg,rgba(255,255,255,.15),transparent);opacity:0;transition:.3s}
...
.footer a{color:var(--accent);font-weight:600;text-decoration:none;display:flex;align-items:center;gap:4px;transition:.2s}
.footer a:hover{color:var(--accent2);transform:scale(1.02)}
...
<div class="wrap">
  <div class="card">
    ...
    <div class="hint">
      ...
      <span class="hint-val" onclick="document.getElementById('pw').value='123456';document.getElementById('pw').focus();this.style.transform='scale(0.95)';setTimeout(()=>this.style.transform='scale(1)',150)">123456</span>
    </div>
    <form id="form">
      <div class="field">
...
*{margin:0;padding:0;box-sizing:border-box}
:root{
  --bg:#0f0a04;--bg2:#1a1208;--bg3:#261c0e;
  --card:#1c140a;--card-b:rgba(245,158,11,0.12);--card-bh:rgba(245,158,11,0.25);
  --accent:#F59E0B;--accent2:#FBBF24;--accent-d:rgba(245,158,11,0.08);
  ...
  --t1:#FFF8ED;--t2:#C8B088;--t3:#8B7A5A;
  --sidebar-w:248px;--radius:16px;
  --shadow:0 4px 24px rgba(0,0,0,0.5);
}
[data-theme="light"]{
  --bg:#FBF5ED;--bg2:#F5EDE0;--bg3:#EDE0CC;
  --card:#FFFFFF;--card-b:rgba(245,158,11,0.15);--card-bh:rgba(245,158,11,0.3);
  --accent:#D97706;--accent2:#B45309;--accent-d:rgba(217,119,6,0.08);
...
.logo-name{font-size:14px;font-weight:800;color:var(--t1);background:linear-gradient(135deg,#FBBF24,#F59E0B);-webkit-background-clip:text;-webkit-text-fill-color:transparent}
...
.mob-title{color:var(--t1);font-size:13px;font-weight:800;background:linear-gradient(135deg,#FBBF24,#F59E0B);-webkit-background-clip:text;-webkit-text-fill-color:transparent}
...
.srv-panel{background:linear-gradient(145deg,var(--bg3) 0%,var(--card) 60%);border:1px solid var(--card-b);border-radius:22px;overflow:hidden;box-shadow:var(--shadow);position:relative}
.srv-panel::before{content:'';position:absolute;top:-60px;left:-60px;width:200px;height:200px;background:radial-gradient(circle,rgba(245,158,11,0.05),transparent 70%);pointer-events:none}
...
.srv-hero-icon{width:50px;height:50px;border-radius:14px;background:linear-gradient(135deg,#F59E0B,#D97706);display:flex;align-items:center;justify-content:center;color:#0f0a04;font-size:22px;flex-shrink:0;box-shadow:0 6px 20px rgba(245,158,11,.2)}
...
.srv-tile{display:flex;align-items:center;gap:11px;background:rgba(0,0,0,.18);border:1px solid var(--card-b);border-radius:13px;padding:12px 14px;transition:.25s}
[data-theme="light"] .srv-tile{background:rgba(217,119,6,.03)}
...
.pw-panel{background:linear-gradient(145deg,var(--bg3) 0%,var(--card) 60%);border:1px solid var(--card-b);border-radius:22px;overflow:hidden;box-shadow:var(--shadow);position:relative}
.pw-panel::before{content:'';position:absolute;top:-60px;right:-60px;width:200px;height:200px;background:radial-gradient(circle,rgba(139,92,246,0.04),transparent 70%);pointer-events:none}
.pw-hero{display:flex;align-items:center;gap:14px;padding:22px 24px 18px;position:relative;z-index:1}
.pw-hero-icon{width:50px;height:50px;border-radius:14px;background:linear-gradient(135deg,#8B5CF6,#6D48D6);display:flex;align-items:center;justify-content:center;color:#fff;font-size:22px;flex-shrink:0;box-shadow:0 6px 20px rgba(139,92,246,.2)}
...
.pw-input{width:100%;padding:11px 42px 11px 14px;border-radius:11px;border:1px solid var(--card-b);background:rgba(0,0,0,.2);color:var(--t1);font-family:inherit;font-size:12.5px;outline:none;transition:.2s}
[data-theme="light"] .pw-input{background:#fff}
.pw-input:focus{border-color:rgba(139,92,246,.4);box-shadow:0 0 0 3px rgba(139,92,246,.06)}
.pw-eye{position:absolute;left:12px;top:34px;background:none;border:none;color:var(--t3);cursor:pointer;font-size:16px;padding:4px;display:flex;transition:.2s}
...
.pw-strength-seg{flex:1;height:100%;border-radius:3px;background:rgba(139,122,90,.15);transition:.3s}
...
.pw-req{font-size:9.5px;padding:4px 10px;border-radius:7px;background:var(--accent-d);color:var(--t3);font-weight:600;display:flex;align-items:center;gap:4px;transition:.25s}
.pw-req.met{background:var(--green-bg);color:var(--green-t)}
.pw-submit{width:100%;justify-content:center;background:linear-gradient(135deg,#8B5CF6,#6D48D6);color:#fff;border:none;border-radius:12px;padding:12px;font-family:inherit;font-size:13px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:8px;box-shadow:0 6px 20px rgba(139,92,246,.25);transition:.25s}
.pw-submit:hover{transform:translateY(-2px);box-shadow:0 10px 30px rgba(139,92,246,.35)}
...
.conn-hero-tile{background:var(--card);border:1px solid var(--card-b);border-radius:16px;padding:16px 18px;position:relative;overflow:hidden;transition:.3s}
...
.conn-live-badge{display:flex;align-items:center;gap:6px;font-size:10.5px;font-weight:700;color:var(--green-t);background:var(--green-bg);padding:5px 12px;border-radius:20px;border:1px solid rgba(16,185,129,.15)}
...
.conn-card-v2{background:var(--card);border:1px solid var(--card-b);border-radius:18px;padding:0;overflow:hidden;transition:all .3s cubic-bezier(.4,0,.2,1);position:relative}
.conn-card-v2:hover{border-color:var(--card-bh);transform:translateY(-3px);box-shadow:0 14px 32px rgba(0,0,0,.3)}
.conn-card-v2-glow{position:absolute;top:-40px;left:-40px;width:140px;height:140px;background:radial-gradient(circle,rgba(16,185,129,.06),transparent 70%);pointer-events:none}
.conn-card-v2-top{display:flex;align-items:center;gap:12px;padding:16px 17px 13px;position:relative;z-index:1}
.conn-avatar{width:42px;height:42px;border-radius:13px;background:linear-gradient(135deg,var(--green),#0D9668);display:flex;align-items:center;justify-content:center;color:#fff;font-size:18px;flex-shrink:0;position:relative;box-shadow:0 4px 14px rgba(16,185,129,.2)}
...
.conn-ip-copy{background:none;border:none;color:var(--t3);cursor:pointer;font-size:12px;padding:2px;display:flex;transition:.2s}
...
.conn-duration-fill::after{content:'';position:absolute;inset:0;background:linear-gradient(90deg,transparent,rgba(255,255,255,.2),transparent);width:40%;animation:shimmer 1.8s linear infinite}
...
.sub-box{background:rgba(139,92,246,.06);border:1px solid rgba(139,92,246,.15);border-radius:10px;padding:14px 16px;display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap;margin-top:11px}
...
.subs-search input{width:100%;padding:11px 40px 11px 15px;border-radius:12px;border:1px solid var(--card-b);background:var(--card);color:var(--t1);font-family:inherit;font-size:12.5px;outline:none;transition:.2s}
.subs-search input:focus{border-color:rgba(139,92,246,.4);box-shadow:0 0 0 3px rgba(139,92,246,.06)}
...
.sub-card{background:var(--card);border:1px solid var(--card-b);border-radius:20px;padding:0;overflow:hidden;transition:all .3s cubic-bezier(.4,0,.2,1);position:relative}
.sub-card:hover{border-color:var(--card-bh);transform:translateY(-4px);box-shadow:0 16px 36px rgba(0,0,0,.3)}
.sub-card-top{background:linear-gradient(145deg,var(--purple-bg) 0%,transparent 65%);padding:20px 20px 16px;position:relative}
.sub-card-top::before{content:'';position:absolute;top:-30px;left:-30px;width:130px;height:130px;background:radial-gradient(circle,rgba(139,92,246,.08),transparent 70%);pointer-events:none}
.sub-card-head-v2{display:flex;align-items:flex-start;gap:13px;position:relative;z-index:1}
.sub-card-icon{width:46px;height:46px;border-radius:14px;background:linear-gradient(135deg,#8B5CF6,#6D48D6);display:flex;align-items:center;justify-content:center;color:#fff;font-size:20px;flex-shrink:0;box-shadow:0 6px 16px rgba(139,92,246,.2)}
...
.sub-card-stats{display:grid;grid-template-columns:repeat(3,1fr);gap:0;position:relative;z-index:1;margin-top:16px;background:rgba(0,0,0,.18);border:1px solid var(--card-b);border-radius:13px;overflow:hidden}
...
.sub-card-url-row{margin:14px 20px 0;background:rgba(139,92,246,.06);border:1px dashed rgba(139,92,246,.2);border-radius:11px;padding:9px 12px;display:flex;align-items:center;gap:8px}
...
.sub-card-url-copy{background:none;border:none;color:var(--purple);cursor:pointer;font-size:13px;padding:3px;display:flex;flex-shrink:0;transition:.2s}
...
.modal-v2{background:var(--card);border:1px solid var(--card-b);border-radius:22px;padding:0;max-width:430px;width:calc(100% - 32px);max-height:92vh;overflow-y:auto;position:relative;animation:fi .25s ease;box-shadow:0 24px 70px rgba(0,0,0,.5)}
.modal-v2-head{background:linear-gradient(145deg,rgba(139,92,246,.08) 0%,transparent 65%);padding:18px 22px 14px;position:relative;overflow:hidden}
.modal-v2-head::before{content:'';position:absolute;top:-50px;left:-50px;width:160px;height:160px;background:radial-gradient(circle,rgba(139,92,246,.1),transparent 70%);pointer-events:none}
.modal-v2-close{position:absolute;top:14px;left:14px;background:var(--accent-d);border:1px solid var(--card-b);color:var(--t2);width:30px;height:30px;border-radius:9px;font-size:15px;display:flex;align-items:center;justify-content:center;cursor:pointer;z-index:2;transition:.2s}
.modal-v2-close:hover{background:var(--red-bg);color:var(--red-t);border-color:rgba(239,68,68,.2)}
.modal-v2-icon{width:42px;height:42px;border-radius:13px;background:linear-gradient(135deg,#8B5CF6,#6D48D6);display:flex;align-items:center;justify-content:center;color:#fff;font-size:19px;margin-bottom:10px;position:relative;z-index:1;box-shadow:0 8px 18px rgba(139,92,246,.2)}
...
.modal-v2-input-wrap>i{position:absolute;right:13px;top:50%;transform:translateY(-50%);color:var(--t3);font-size:14px;pointer-events:none;transition:.2s;z-index:1}
.modal-v2-input{width:100%;padding:9px 38px 9px 13px;border-radius:11px;border:1px solid var(--card-b);background:rgba(0,0,0,.2);color:var(--t1);font-family:inherit;font-size:12.5px;outline:none;transition:.2s}
[data-theme="light"] .modal-v2-input{background:rgba(124,58,237,.04)}
.modal-v2-input::placeholder{color:var(--t3)}
.modal-v2-input:focus{border-color:rgba(139,92,246,.4);box-shadow:0 0 0 3px rgba(139,92,246,.06);background:rgba(0,0,0,.25)}
[data-theme="light"] .modal-v2-input:focus{background:#fff}
.modal-v2-input:focus~i{color:var(--purple)}
.modal-v2-hint{background:rgba(245,158,11,.06);border:1px solid rgba(245,158,11,.12);border-radius:11px;padding:9px 12px;font-size:10px;color:var(--t2);display:flex;gap:7px;align-items:flex-start;line-height:1.6;margin-top:2px}
...
.modal-v2-btn-cancel{flex:.75;justify-content:center;padding:10px;border-radius:11px;background:transparent;border:1px solid var(--card-b);color:var(--t2);font-family:inherit;font-size:12px;font-weight:700;cursor:pointer;transition:.2s;display:flex;align-items:center}
.modal-v2-btn-cancel:hover{background:var(--accent-d);color:var(--t1)}
.modal-v2-btn-submit{flex:1;justify-content:center;padding:10px;border-radius:11px;background:linear-gradient(135deg,#8B5CF6,#6D48D6);color:#fff;border:none;font-family:inherit;font-size:12px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:6px;box-shadow:0 6px 18px rgba(139,92,246,.2);transition:.25s}
.modal-v2-btn-submit:hover{transform:translateY(-2px);box-shadow:0 10px 24px rgba(139,92,246,.3)}
.modal-v2-btn-submit:active{transform:translateY(0) scale(.98)}
.lmodal-head{background:linear-gradient(145deg,var(--accent-d) 0%,transparent 70%);padding:22px 24px 18px;position:relative;border-bottom:1px solid var(--card-b)}
.lmodal-icon-row{display:flex;align-items:center;gap:12px;position:relative;z-index:1}
.lmodal-icon{width:44px;height:44px;border-radius:13px;background:linear-gradient(135deg,#F59E0B,#D97706);display:flex;align-items:center;justify-content:center;color:#0f0a04;font-size:19px;flex-shrink:0;box-shadow:0 6px 16px rgba(245,158,11,.2)}
...
.lmodal-search input:focus{border-color:rgba(245,158,11,.4);box-shadow:0 0 0 3px rgba(245,158,11,.06)}
...
.lmodal-qbtn{font-size:10px;font-weight:700;padding:5px 11px;border-radius:8px;background:var(--accent-d);color:var(--accent2);border:1px solid var(--card-b);cursor:pointer;transition:.2s;font-family:inherit}
.lmodal-qbtn:hover{background:rgba(245,158,11,.15)}
...
.lrow-v2{display:flex;align-items:center;gap:11px;padding:11px 12px;border-radius:13px;cursor:pointer;transition:.2s;margin-bottom:4px;border:1px solid transparent}
.lrow-v2:hover{background:var(--accent-d)}
.lrow-v2.checked{background:rgba(245,158,11,.06);border-color:rgba(245,158,11,.15)}
.lrow-v2-check{width:20px;height:20px;border-radius:7px;border:2px solid var(--card-b);flex-shrink:0;display:flex;align-items:center;justify-content:center;transition:.2s;background:rgba(0,0,0,.14)}
.lrow-v2.checked .lrow-v2-check{background:var(--accent);border-color:var(--accent)}
.lrow-v2-check i{font-size:12px;color:#0f0a04;opacity:0;transform:scale(.5);transition:.2s}
...
.lrow-v2.checked .lrow-v2-avatar{background:var(--accent);color:#0f0a04}
...
.lrow{display:flex;align-items:center;gap:8px;padding:7px 0;border-bottom:1px solid rgba(245,158,11,.04)}
...
.conn-card{background:var(--card);border:1px solid var(--card-b);border-radius:16px;padding:15px 17px;transition:.3s;position:relative;overflow:hidden}
...
.log-item{display:flex;gap:12px;padding:11px 0;border-bottom:1px solid rgba(245,158,11,.04);position:relative;transition:.2s}
.log-item:hover{background:var(--accent-d);margin:0 -4px;padding:11px 4px;border-radius:6px}
...
.erow{padding:9px 0;border-bottom:1px solid rgba(245,158,11,.04)}
...
<aside class="sidebar" id="sb">
  ...
  <div class="sb-foot">
    ...
    <a class="tg-btn" href="https://t.me/royalpanelv2" target="_blank" rel="noopener"><i class="ti ti-brand-telegram"></i> @royalpanelv2</a>
...
function initCharts(){
  ...
  const grad1=makeGradient(c1,'rgba(245,158,11,.35)','rgba(245,158,11,0)');
  const opts={
    ...
    plugins:{
      ...
      tooltip:{
        backgroundColor:'rgba(28,20,10,.97)',borderColor:'rgba(245,158,11,.25)',borderWidth:1,
        titleColor:'#FFF8ED',bodyColor:'#C8B088',padding:11,cornerRadius:10,displayColors:false,
    ...
    scales:{
      x:{grid:{display:false},border:{display:false},ticks:{color:'#8B7A5A',font:{size:9,family:'Vazirmatn'}}},
      y:{grid:{color:'rgba(245,158,11,.05)'},border:{display:false},ticks:{color:'#8B7A5A',font:{size:9,family:'Vazirmatn'},callback:v=>v+' MB'}}
    },
    elements:{line:{capBezierPoints:true}}
  };
  const ds1={label:'MB',data:[],borderColor:'#F59E0B',backgroundColor:grad1,fill:true,tension:.42,pointRadius:0,pointHoverRadius:6,pointHoverBackgroundColor:'#F59E0B',pointHoverBorderColor:'#fff',pointHoverBorderWidth:2,borderWidth:2.5};
  ...
  const gradFill3=makeGradientV2(c3ctx,'rgba(245,158,11,.4)','rgba(245,158,11,.06)','rgba(245,158,11,0)');
  ch3=new Chart(document.getElementById('ch3'),{
    type:'line',
    data:{labels:[],datasets:[
      {label:'مصرف',data:[],borderColor:'#F59E0B',backgroundColor:gradFill3,fill:true,tension:.45,pointRadius:0,pointHoverRadius:7,pointHoverBackgroundColor:'#fff',pointHoverBorderColor:'#F59E0B',pointHoverBorderWidth:3,borderWidth:3,order:2},
    ...
    options:{
      ...
      plugins:{
        legend:{display:false},
        tooltip:{
          backgroundColor:'rgba(28,20,10,.97)',borderColor:'rgba(245,158,11,.3)',borderWidth:1,
          titleColor:'#FFF8ED',bodyColor:'#C8B088',padding:13,cornerRadius:12,displayColors:true,boxPadding:4,
      ...
      scales:{
        x:{grid:{display:false},border:{display:false},ticks:{color:'#8B7A5A',font:{size:9.5,family:'Vazirmatn'},maxRotation:0}},
        y:{grid:{color:'rgba(245,158,11,.04)'},border:{display:false},ticks:{color:'#8B7A5A',font:{size:9.5,family:'Vazirmatn'},callback:v=>v+' MB'}}
      }
    }
  });
...
let ws;
function wsLog(c,m){const l=document.getElementById('ws-log'),p=document.createElement('p');const colors={ok:'#34D399',err:'#F87171',info:'#C8B088',sent:'#FBBF24'};p.style.color=colors[c]||'#fff';p.textContent='['+new Date().toLocaleTimeString('fa-IR')+'] '+m;l.appendChild(p);l.scrollTop=l.scrollHeight}
...
def get_public_page_html(uuid_key: str) -> str:
    """صفحه پابلیک ساب v3 — طراحی حرفه‌ای با تم زرد/نارنجی و انیمیشن‌های روان"""
...
:root{{
  --bg:#0f0a04;--bg2:#1a1208;--bg3:#261c0e;
  --card:#1c140a;--card-b:rgba(245,158,11,0.1);--card-bh:rgba(245,158,11,0.22);
  --accent:#F59E0B;--accent2:#FBBF24;--accent-d:rgba(245,158,11,0.06);
...
[data-theme="light"]{{
  --bg:#FBF5ED;--bg2:#F5EDE0;--bg3:#EDE0CC;
  --card:#FFFFFF;--card-b:rgba(245,158,11,0.12);--card-bh:rgba(245,158,11,0.25);
  --accent:#D97706;--accent2:#B45309;--accent-d:rgba(217,119,6,0.05);
  ...
  --t1:#1A1208;--t2:#5C4A2A;--t3:#8B7A5A;
  --shadow:0 12px 36px rgba(20,15,8,0.1);
}}
html,body{{min-height:100%;background:var(--bg);font-family:var(--serif);color:var(--t1);font-size:14px;transition:background .4s,color .4s}}
.bg-fx{{position:fixed;inset:0;background:radial-gradient(ellipse 70% 45% at 50% -8%,rgba(245,158,11,0.08),transparent 62%),var(--bg);z-index:0;pointer-events:none;transition:background .4s}}
.grid-fx{{position:fixed;inset:0;background-image:linear-gradient(rgba(245,158,11,0.02) 1px,transparent 1px),linear-gradient(90deg,rgba(245,158,11,0.02) 1px,transparent 1px);background-size:46px 46px;z-index:0;pointer-events:none}}
.orb{{position:fixed;border-radius:50%;filter:blur(100px);z-index:0;animation:fl 14s ease-in-out infinite;pointer-events:none}}
.o1{{width:350px;height:350px;background:rgba(245,158,11,0.04);top:-80px;right:-80px}}
.o2{{width:250px;height:250px;background:rgba(251,191,36,0.03);bottom:-60px;left:-60px;animation-delay:7s}}
@keyframes fl{{0%,100%{{transform:translateY(0) scale(1)}}33%{{transform:translateY(-18px) scale(1.02)}}66%{{transform:translateY(12px) scale(0.98)}}}}
...
.brand-img{{width:42px;height:42px;border-radius:13px;overflow:hidden;border:1px solid var(--card-b);box-shadow:0 0 20px rgba(245,158,11,0.08);flex-shrink:0;background:linear-gradient(135deg,#F59E0B,#D97706)}}
.brand-img svg{{width:100%;height:100%;padding:7px;fill:#fff}}
.brand-name{{font-size:15px;font-weight:800;color:var(--t1);letter-spacing:-.01em;background:linear-gradient(135deg,#FBBF24,#F59E0B);-webkit-background-clip:text;-webkit-text-fill-color:transparent}}
...
.icon-btn:hover{{background:var(--accent-d);color:var(--accent2);border-color:var(--card-bh);transform:translateY(-1px)}}
...
.sub-info::before{{content:'';position:absolute;top:0;right:0;width:180px;height:180px;background:radial-gradient(circle at top right,rgba(245,158,11,0.06),transparent 70%);pointer-events:none}}
...
.copy-all-bar{{display:flex;align-items:center;gap:12px;background:linear-gradient(120deg,#F59E0B 0%,#D97706 100%);border-radius:18px;padding:16px 19px;margin-bottom:18px;box-shadow:0 10px 30px rgba(245,158,11,.2);flex-wrap:wrap;transition:.3s}}
.copy-all-bar:hover{{box-shadow:0 14px 40px rgba(245,158,11,.25);transform:translateY(-1px)}}
.copy-all-text{{flex:1;min-width:160px}}
.copy-all-title{{font-size:13.5px;font-weight:800;color:#0f0a04;display:flex;align-items:center;gap:6px}}
.copy-all-sub{{font-size:10px;color:rgba(15,10,4,.7);margin-top:3px}}
.copy-all-btn{{background:#0f0a04;color:#FBBF24;border:none;border-radius:12px;padding:10px 19px;font-family:inherit;font-size:12.5px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:6px;transition:.25s;white-space:nowrap}}
.copy-all-btn:hover{{transform:translateY(-2px);box-shadow:0 6px 20px rgba(0,0,0,.25);background:#1a1208}}
...
.cfg-card:hover{{border-color:var(--card-bh);box-shadow:var(--shadow);transform:translateY(-2px)}}
...
.cfg-vless{{background:rgba(0,0,0,.25);border:1px solid var(--card-b);border-radius:10px;padding:11px 13px;font-size:9.8px;font-family:ui-monospace,monospace;color:var(--accent2);word-break:break-all;line-height:1.7;margin-top:9px;max-height:90px;overflow-y:auto;transition:.3s}}
...
.btn-g{{background:var(--accent-d);color:var(--accent2);border:1px solid rgba(245,158,11,.1)}}
.btn-g:hover{{background:rgba(245,158,11,.15)}}
.btn-pur{{background:var(--purple-bg);color:#A78BFA;border:1px solid rgba(139,92,246,.1)}}
.btn-pur:hover{{background:rgba(139,92,246,.15)}}
...
.lock-card{{background:var(--card);border:1px solid var(--card-b);border-radius:26px;padding:0;text-align:center;max-width:380px;width:100%;box-shadow:var(--shadow);overflow:hidden;position:relative;animation:slideUp 0.6s cubic-bezier(.16,1,.3,1)}}
.lock-banner{{background:linear-gradient(150deg,rgba(245,158,11,.1),rgba(245,158,11,.02) 70%);padding:38px 30px 26px;position:relative}}
...
.lock-inp{{width:100%;padding:13px 44px 13px 44px;border-radius:13px;border:1px solid var(--card-b);background:rgba(0,0,0,.2);color:var(--t1);font-family:inherit;font-size:14px;outline:none;text-align:center;letter-spacing:.14em;transition:.25s}}
...
.lock-eye{{position:absolute;left:13px;top:50%;transform:translateY(-50%);background:none;border:none;color:var(--t3);cursor:pointer;font-size:16px;padding:4px;display:flex;transition:.2s}}
...
.lock-err{{color:var(--red-t);font-size:11.5px;margin-bottom:10px;min-height:16px;display:flex;align-items:center;justify-content:center;gap:5px;animation:shake 0.4s ease}}
