...
# تغییرات ظاهری: تم آبی → زرد/نارنجی + تغییر نام به Royal Gateway
...
.brand-name{font-size:18px;font-weight:800;background:linear-gradient(135deg,#FBBF24,#F59E0B);-webkit-background-clip:text;-webkit-text-fill-color:transparent}
...
def get_public_page_html(uuid_key: str) -> str:
    """صفحه پابلیک ساب v3 — طراحی حرفه‌ای با تم زرد/نارنجی"""
